...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/marko-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15318&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/marko-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `marko` can be installed with:

```
conda install marko
```

It is possible to list all of the versions of `marko` available on your platform with:
